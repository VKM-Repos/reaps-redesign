...
export const reviews = [
  {
    ...
    reviewer: {
      ...
      comments: [
        {
          id: "1",
          comment: "A better understanding of usage can aid in prioritizing future efforts i'm sorry I replied to your emails after only three weeksLet it grow as it did so long ago, its just one tiny tree, but its all we really need, lets celebrate the world’s rebirth, i say let it grow.",
