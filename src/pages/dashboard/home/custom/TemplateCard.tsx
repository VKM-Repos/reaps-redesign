...
export default function TemplateCard() {
    return (
        <a href="" className={`relative w-full md:max-w-[17.5rem] flex flex-col gap-8 justify-left p-4 rounded-2xl hover:bg-[#14155E14] hover:border-none border border-[#0C0C0F29]`} download>
