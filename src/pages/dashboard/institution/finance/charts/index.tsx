...
import { MonthlyPaymentTooltip, RevenueTooltip } from "./tooltips";
import { paymentsData, paymentsGenderData, revenueComparisonData, revenueData } from "./data";
...
import { payment_by_gender_config, revenue_comparison_config } from "./configs";
...
export function RevenueComparisonChart() {
    return (
        <ChartContainer config={revenue_comparison_config} className="w-full min-h-[12.5rem]">
