...
export default function PricingSheet({ handleNext }: CategoryProps) {
    ...
    return (
        ...
        <SheetHeader className="px-1 mt-24 md:mt-16">
            ...
            <SheetDescription className="text-left md:text-center text-[#454745] text-sm inter">Enter the amount to be charged for this category.</SheetDescription>
        </SheetHeader>
        <div className="w-full mx-auto my-0 px-1">
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-[3.75rem] !focus:border-none">
                    ...
                    <Button variant={isValid ? "default" : "ghost"} className={`focus:outline-none`}>Finish</Button>
                </form>
            </Form>
        </div>
    </>
