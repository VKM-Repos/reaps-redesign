                    ...
                    <div className="w-[90%] mx-auto my-0 border-b border-b-[#E0E0E0] relative">
                        <div className="flex flex-col gap-[3.875rem] items-center">
                            <div className="flex gap-1">
                                <h1 className="text-[1.375rem] text-[#040C21]">Ethical Approval Request Fee</h1>
                                <Badge className="text-primary bg-[#192C8A1A] flex items-center justify-center hover:bg-[#192C8A1A] text-[0.625rem] font-semibold">{educationLevel} </Badge>
                            </div>
                            <h1 className="text-primary font-extrabold text-3xl">{amountToPay}</h1>
                        </div>
                        <img src="img/undraw_receipt_re_fre3.png" alt="Illustration of man carrying receipt" />
                    </div>

                </div>
                <div className="flex items-center justify-between py-3">
                    <Button className="w-full md:max-w-[5.57rem] py-[0.5rem] px-5 rounded-[0.375rem] text-destructive font-semibold text-sm">Cancel</Button>
                    <Popover>
