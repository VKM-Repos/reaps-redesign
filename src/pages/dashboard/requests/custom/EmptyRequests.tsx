        ...
        <>
            ...
            <div className="mx-auto my-0 w-full md:4/5 flex flex-col justify-center items-center">
                ...
                <div className="flex flex-col gap-6 w-full max-w-[37rem] text-center">
                    ...
                    <Button onClick={() => {handleFunc()}} className="flex gap-4 items-center justify-center py-3 px-6 w-full max-w-[18rem] mx-auto"><span><GoogleDoc /></span>Request Ethical Approval</Button>
                </div>
            </div>
        </>   
    )
