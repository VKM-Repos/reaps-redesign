    ...
    return (
        <>
            ...
            <div className="flex flex-col gap-[2rem]">
                <div className={`flex  ${isLarge ? 'flex-col gap-5' : 'flex-row gap-auto items-center'} justify-between mx-auto w-full`}>
                    <h1 className="text-[1.875rem] font-bold">Research Templates</h1>
                    <Sheet>
                        <SheetTrigger asChild>
                            <Button className={`flex gap-4 items-center justify-center py-3 px-6 ${isLarge ? 'max-w-fit' : 'max-w-[16.75rem]'}`}><span><AddIcon /></span>Upload</Button>
                        </SheetTrigger>
